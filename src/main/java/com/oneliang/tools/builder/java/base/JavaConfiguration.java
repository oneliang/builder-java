...
public abstract class JavaConfiguration extends Configuration {
    ...
    protected List<String> proguardClasspathList = new CopyOnWriteArrayList<String>();
    ...
    protected void initializeAllProject() {
        ...
        // List<Project>
        // mainProjectParentProjectList=mainProject.getParentProjectList();
    ...
    /**
     * @param jarStorePassword
     *            the jarStorePassword to set
     */
    ...
    /**
     * @param jarKeyPassword
     *            the jarKeyPassword to set
     */
    ...
    /**
     * @param projectTaskNodeInsertName
     *            the projectTaskNodeInsertName to set
     */
    ...
    /**
     * @return the proguardClasspathList
     */
    public List<String> getProguardClasspathList() {
        return proguardClasspathList;
    }
}
